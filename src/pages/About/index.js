import "./About.scss";
import story from "./img/storyPic.svg";
import twitter from "./img/Icon-Twitter.svg";
import instagram from "./img/icon-instagram.svg";
import linkedin from "./img/Icon-Linkedin.svg";
import employ1 from "./img/epl1.svg";
import employ2 from "./img/epl2.svg";
import employ3 from "./img/epl3.svg";
    ...
    <main className="about">
      ...
      <section className="about__employ">
        <div className="about__cards">
          <figure className="about__card">
            <div className="about__card--img">
              {" "}
              <img src={employ1} alt="employee" />
            </div>
            <h2 className="about__card--title">Tom Cruise</h2>
            <p className="about__card--desc">Founder & Chairman</p>
          ...
          <figure className="about__card">
            <div className="about__card--img">
              <img src={employ2} alt="employee" />
            </div>
            <h2 className="about__card--title">Emma Watson</h2>
            <p className="about__card--desc">Managing Director</p>
            <div className="about__card--social">
              <img src={twitter} alt="twitter" />
              <img src={linkedin} alt="linkedin" />
              <img src={instagram} alt="instagram" />
          ...
          <figure className="about__card">
            <div className="about__card--img">
              <img src={employ3} alt="employee" />
            </div>
            <h2 className="about__card--title">Will Smith</h2>
            <p className="about__card--desc">Product Designer</p>
            <div className="about__card--social">
              <img src={twitter} alt="twitter" />
              <img src={linkedin} alt="linkedin" />
              <img src={instagram} alt="instagram" />
        ...
        <div className="about__dots">
          <button className="dot dot--active"></button>
